...
> **For agentic workers:** REQUIRED: Use spoc:subagent-driven-development (if subagents available) or spoc:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- **REQUIRED:** Use spoc:subagent-driven-development
- Do NOT offer a choice - subagent-driven is the standard approach
- Fresh subagent per task + two-stage review

**If harness does NOT have subagents:**
- Execute plan in current session using spoc:executing-plans
