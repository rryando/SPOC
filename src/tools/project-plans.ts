...
export function registerProjectPlanTools(server: McpServer) {
  ...
  server.tool(
    ...
    async (params) => {
      try {
        requireWriteGate(params.confirmationToken, params.slug, "tool:create_project_plan");
  ...
  server.tool(
    ...
    async (params) => {
      try {
        requireWriteGate(params.confirmationToken, params.slug, "tool:update_project_plan_meta");
  ...
  server.tool(
    ...
    async (params) => {
      try {
        requireWriteGate(params.confirmationToken, params.slug, "tool:update_project_plan_body");
  ...
  server.tool(
    ...
    async (params) => {
      try {
        requireWriteGate(params.confirmationToken, params.slug, "tool:delete_project_plan");
