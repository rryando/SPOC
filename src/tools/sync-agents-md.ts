...
> Auto-generated by cc-dag. Do not edit manually.
...
export function registerSyncAgentsMd(server: McpServer) {
  server.tool(
    "sync_agents_md",
    "Generate and write an AGENTS.md file to a project's workspace directories. Assembles coding discipline rules, LLM-provided codebase analysis, and cc-dag project context into a single guardrail document. The caller should analyze the project codebase first and provide findings via codebaseAnalysis.",
    {
