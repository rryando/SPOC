...
- **SYNC:** \`spoc graphify-sync <slug>\` re-extracts and ingests new structural knowledge. Use when \`lastSyncedAt\` > 7 days or major refactor commits landed.
...
|---------|------------|-------|
| \`graphify update <path> --force --no-cluster\` | INIT (auto) and SYNC (\`spoc graphify-sync\`) | orchestrator / CLI |
